...
class FloatValueParserTest {
    ...
    final void testParseStringValueOK() {
        ...
        final FloatValueParser parser = new FloatValueParser();
        ...
        // When
        final Float value = parser.getValue(cell, evaluator);
        // Then
        assertThat(value).isNotNull().isEqualTo(Float.parseFloat(strValue));
    }
    ...
    final void testParseStringValueKO() {
        ...
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                strValue, Float.class.getName(), 0, 0, SHEET_NAME);
        // When
    ...
    @Test
    final void testParseFloatValueOK() {
        // Given
        ...
        final Float value = parser.getValue(cell, evaluator);
        // Then
        assertThat(value).isNotNull().isEqualTo((float) dblValue);
    }
    ...
    final void testParseBooleanValueKO() {
        ...
        when(cell.getColumnIndex()).thenReturn(0);
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                "true", Float.class.getName(), 0, 0, SHEET_NAME);
        // When
        // Then
        Throwable exception = assertThrows(ExcelReaderException.class,
                () -> parser.getValue(cell, evaluator));
    ...
    final void testNullValueOK() {
        ...
        final FloatValueParser parser = new FloatValueParser();
        // When
        final Float value = parser.getValue(null, evaluator);
        // Then
        assertThat(value).isNull();
    }
    ...
    final void testFormula() {
        ...
        final Float value = parser.getValue(cell, evaluator);
        // Then
        assertThat(value).isEqualTo((float) dblValue);
    }
}
