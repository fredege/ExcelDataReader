...
class ShortValueParserTest {
    ...
    final void testParseStringValueOK() {
        ...
        final ShortValueParser parser = new ShortValueParser();
        ...
        // When
        final Short value = parser.getValue(cell, evaluator);
        // Then
        assertThat(value).isNotNull().isEqualTo(Short.valueOf(strValue));
    }
    ...
    final void testParseStringValueKO() {
        ...
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                strValue, Short.class.getName(), 0, 0, SHEET_NAME);
        // When
        // Then
    ...
    @Test
    final void testParseShortValueOK() {
        // Given
        ...
        final Short value = parser.getValue(cell, evaluator);
        // Then
        assertThat(value).isNotNull().isEqualTo((short) 1);
    }
    ...
    final void testParseBooleanValueKO() {
        ...
        when(cell.getColumnIndex()).thenReturn(0);
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                "true", Short.class.getName(), 0, 0, SHEET_NAME);
        // When
        // Then
        Throwable exception = assertThrows(ExcelReaderException.class,
                () -> parser.getValue(cell, evaluator));
    ...
    final void testNullValueOK() {
        ...
        final ShortValueParser parser = new ShortValueParser();
        // When
        final Short value = parser.getValue(null, evaluator);
        // Then
        assertThat(value).isNull();
    }
}
