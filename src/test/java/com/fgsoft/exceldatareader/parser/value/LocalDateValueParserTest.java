...
class LocalDateValueParserTest {
    ...
    final void testParseStringOK() {
        ...
        final String strValue = localDate.format(DateTimeFormatter.ISO_LOCAL_DATE);
    ...
    final void testParseStringKOAnyString(final String strValue) {
        ...
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                strValue, LocalDateTime.class.getName(), ROW_NUM, COL_NUM, SHEET_NAME);
        // When
    ...
    final void testParseDoubleOK() {
        ...
        final LocalDate actual = parser.getValue(cell, evaluator);
        // Then
        assertThat(actual).isEqualTo(dateTime.toLocalDate());
    }
    ...
    final void testParseDoubleKO() {
        ...
        when(cell.getNumericCellValue()).thenReturn(dblValue);
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                dblValue, LocalDateTime.class.getName(), ROW_NUM, COL_NUM, SHEET_NAME);
        // When
        Throwable exception = assertThrows(ExcelReaderException.class,
                () -> parser.getValue(cell, evaluator));
        // Then
    ...
    final void testParseBooleanValueKO() {
        ...
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                "true", LocalDate.class.getName(), 0, 0, SHEET_NAME);
        // When
        // Then
        Throwable exception = assertThrows(ExcelReaderException.class,
                () -> parser.getValue(cell, evaluator));
    ...
    final void testBlankValueOK() {
        ...
        // When
        final LocalDate value = parser.getValue(cell, evaluator);
        // Then
    ...
    final void testNullValueOK() {
        ...
        final LocalDateValueParser parser = new LocalDateValueParser();
        // When
        final LocalDate value = parser.getValue(null, evaluator);
        // Then
        assertThat(value).isNull();
    }
