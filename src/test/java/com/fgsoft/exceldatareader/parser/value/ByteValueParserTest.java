...
class ByteValueParserTest {
    ...
    final void testParseStringValueOK() {
        ...
        final ByteValueParser parser = new ByteValueParser();
        ...
        // When
        final Byte value = parser.getValue(cell, evaluator);
        // Then
        assertThat(value).isNotNull().isEqualTo(Byte.valueOf(strValue));
    }
    ...
    final void testParseStringValueKO() {
        ...
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                strValue, Byte.class.getName(), 0, 0, SHEET_NAME);
        // When
        // Then
    ...
    @Test
    final void testParseByteValueOK() {
        // Given
        ...
        final Byte value = parser.getValue(cell, evaluator);
        // Then
        assertThat(value).isNotNull().isEqualTo((byte) 1);
    }
    ...
    final void testParseBooleanValueKO() {
        ...
        when(cell.getColumnIndex()).thenReturn(0);
        final String message = String.format(ExcelReaderErrorCode.INCORRECT_VALUE_FOR_TYPE.getMessage(),
                "true", Byte.class.getName(), 0, 0, SHEET_NAME);
        // When
        // Then
        Throwable exception = assertThrows(ExcelReaderException.class,
                () -> parser.getValue(cell, evaluator));
    ...
    final void testNullValueOK() {
        ...
        final ByteValueParser parser = new ByteValueParser();
        // When
        final Byte value = parser.getValue(null, evaluator);
        // Then
        assertThat(value).isNull();
    }
}
